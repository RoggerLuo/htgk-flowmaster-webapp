export default function(){
    ...
    json.childShapes.forEach((el,index)=>{
        ...
        if(el.stencil.id == 'CirculationTask') approveArr.push({text:el.properties.name,value:el.resourceId})
        if(el.stencil.id == 'ManualTask') approveArr.push({text:el.properties.name,value:el.resourceId})
